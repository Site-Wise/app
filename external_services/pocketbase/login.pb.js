// Check if this is a user registration request (e.g., by checking for the presence of specific registration fields)
onRecordAuthWithPasswordRequest((e) => {
  ...
  // e.app.logger().debug(`Debug message!${turnstileToken}`)
