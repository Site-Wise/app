 ...
 * Manages credit notes issued by vendors
 */

import { pb } from '../client';
import { getCurrentSiteId, getCurrentUserRole } from '../context';
import { calculatePermissions } from '../types/permissions';
import type { VendorCreditNote } from '../types';
import { mapRecordToVendorCreditNote, mapRecordToVendor, mapRecordToVendorReturn } from './mappers';
...
export class VendorCreditNoteService {
  ...
  mapRecordToCreditNote(record: any): VendorCreditNote {
    return {
      id: record.id,
