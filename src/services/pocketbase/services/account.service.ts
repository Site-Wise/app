/**
 * Account Service
 * Manages financial accounts (bank, cash, credit card, etc.)
 */
...
let accountTransactionServiceRef: { calculateAccountBalance: (id: string) => Promise<number> } | null = null;

export function setAccountTransactionServiceRef(service: { calculateAccountBalance: (id: string) => Promise<number> }) {
